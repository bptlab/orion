...
def apply(dfg0: Dict[Tuple[str, str], float], att_config: None, log: EventLog = None, activities_count : Dict[str, int] = None, soj_time: Dict[str, float] = None, parameters: Optional[Dict[Any, Any]] = None, variant=DEFAULT_VARIANT) -> graphviz.Digraph:
    """
    ...
    """
    dfg = deepcopy(dfg0)
    return exec_utils.get_variant(variant).apply(dfg, log=log, att_config=att_config, activities_count=activities_count, soj_time=soj_time, parameters=parameters)
