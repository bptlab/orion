...
def view_dfg(dfg: dict, start_activities: dict, end_activities: dict, att_config: None, format: str = "png",
    ...
    parameters[dfg_parameters.START_ACTIVITIES] = start_activities
    parameters[dfg_parameters.END_ACTIVITIES] = end_activities
    gviz = dfg_visualizer.apply(dfg, log=log, variant=dfg_visualizer.Variants.FREQUENCY, att_config=att_config,
